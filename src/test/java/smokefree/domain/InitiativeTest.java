...
public class InitiativeTest {
	...
	@Test
	public void should_allow_create_initiative() {
	...
	@Test
	public void should_allow_citizen_join_when_first_time() {
	...
	@Test
	public void should_ignore_joins_to_same_initiative_when_same_citizen() {
		fixture
				.given(
	...
	@Test
	public void should_allow_manager_join_when_first_time() {
		fixture.given(initiativeCreated("initiative-1", not_started))
	...
	@Test
	public void should_ignore_joins_to_same_initiative_when_same_manager() {
		fixture
				.given(
						initiativeCreated("initiative-1", not_started),
	...
	@Test
	public void should_have_inprogress_status_when_decide_to_become_smokefree() {
		fixture
				.given(
						initiativeCreated("initiative-1", not_started),
						managerJoined(MANAGER_1))
	...
	@Test
	public void should_ignore_decision_when_wrong_current_status() {
	...
	@Test
	public void should_have_stopped_status_when_not_deciding_to_become_smokefree() {
	...
	@Test
	public void should_deny_status_change_when_not_manager() {
		fixture
				.given(
						initiativeCreated("initiative-1", not_started),
	...
	@Test
	public void should_progress_states_when_commit_to_smokefree_date() {
	...
	/*@Test
	public void should_not_accept_updated_smokefree_date_when_original_date_in_past() {
	...
	@Test
	public void should_allow_record_smokefreeobservation() {
		LocalDate yesterday = now().minusDays(1);
		LocalDate today = now();
